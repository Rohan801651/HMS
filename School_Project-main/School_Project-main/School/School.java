...
public class School {
    ...
    public void addStudents(String studentName[], String studentID[], String studentClass[]) {
        try {
            FileWriter writer = new FileWriter("School/StudentsDataBase.txt", true);
    ...
    protected void displayStudentsDataBase() {
        try{
           FileReader file = new FileReader("School/StudentsDataBase.txt");
    ...
    public void addTeachers(String teacherName[], String subject[], int Class[]) {
        try {
            FileWriter writer = new FileWriter("School/TeachersData.txt",true);
